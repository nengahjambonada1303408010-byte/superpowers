...
echo -e "  ${BLUE}bash run-termux.sh${NC}          # mode LAN (WiFi sama)"
echo -e "  ${BLUE}bash run-termux.sh localhost${NC} # jika Termux di HP yang sama"
echo ""
echo -e "  Lalu buka ${BOLD}Expo Go${NC} di HP dan scan QR code."
echo ""
echo -e "  ${YELLOW}Tips:${NC}"
echo -e "  • Mode ${BOLD}lan${NC}: HP & Termux harus terhubung ke WiFi yang sama"
echo -e "  • Mode ${BOLD}localhost${NC}: jika Termux & Expo Go ada di satu HP"
echo -e "  • Jangan pakai ${BOLD}--tunnel${NC} — ngrok tidak tersedia di Termux"
